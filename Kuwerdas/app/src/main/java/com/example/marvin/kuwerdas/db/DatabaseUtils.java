...
public class DatabaseUtils {
    ...
    public static void insertSampleSongs(){
        ...
        new DatabaseUtils.InsertSongDatabaseTask(SongUtil.asSong("Mundo","IV of Spades","San darating ang mga salita\n" +
        ...
        new DatabaseUtils.InsertSongDatabaseTask(SongUtil.asSong("Ligaya","Eraserheads","Ilang awit pa ba ang aawitin, o giliw ko?\n" +
        ...
        new DatabaseUtils.InsertSongDatabaseTask(SongUtil.asSong("Kisapmata","Rivermaya","Nitong umaga lang, Pagka lambing-lambing\n" +
        ...
        new DatabaseUtils.InsertSongDatabaseTask(SongUtil.asSong("Harana","Parokya ni Edgar","Uso pa ba ang harana\n" +
        ...
        new DatabaseUtils.InsertSongDatabaseTask(SongUtil.asSong("Sa Ngalan ng Pag-ibig","December Avenue","Uso pa ba ang harana\n" +
                "Marahil ikaw ay nagtataka\n" +
                "Sino ba 'tong mukhang gago\n" +
                "Nagkandarapa sa pagkanta\n" +
                "At nasisintunado sa kaba\n" +
